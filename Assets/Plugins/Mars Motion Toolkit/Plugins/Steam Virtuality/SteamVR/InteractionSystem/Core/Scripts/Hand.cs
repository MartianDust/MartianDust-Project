...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		/* custom changes by Mars Motion to cover the case of hovering ending via nullification of the interactable */
		...
		public Interactable hoveringInteractable
		{
			...
			set
			{
				if ( _hoveringInteractable != value )
				{
					...
					_hoveringInteractable = value;/* custom changes by Mars Motion to cover the case of hovering ending via nullification of the interactable */
		...
		private void UpdateHovering()
		{
			...
			foreach ( Collider collider in overlappingColliders )
			{
				...
				Interactable contacting = collider.GetComponentInParent<Interactable>();/* custom changes by Mars Motion */
